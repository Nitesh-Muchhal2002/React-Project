...
function App() {
  //length numberAllowed charAllowed is variable
  ...
  const passwordGenrator = useCallback(() => {
    ...
    setPassword(pass)
  }, [length, numberAllowed, charAllowed]) //optimize
      ...
      my-8 text-red-500 bg-gray-800'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          ...
          <button className='outline-none 
            bg-yellow-700 text-white px-3 py-0.5 shrink-0 hover:bg-blue-600'
